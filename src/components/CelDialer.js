...
export default function CelDialer() {

    return (
        <>
            <div data-dial-init className="fixed sm:hidden end-6 bottom-6 group">
                <div id="speed-dial-menu-click" className="flex flex-col hidden items-center mb-4 space-y-2">
