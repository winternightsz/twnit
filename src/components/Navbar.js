...
<nav className="bg-white">
  <div className="max-w-screen-xl lg:rounded-lg lg:mt-2 flex bg-twOfficial items-center justify-between md:justify-evenly mx-auto p-4">
    ...
    <button onClick={toggleMenu} type="button" className="inline-flex items-center p-2 w-10 h-10  text-sm text-white rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" >
