...
export default function AccsCard ({ nome, descricao, linkNitter, foto }) {
    return (
<div className="bg-white p-8 overflow-hidden w-full h-full rounded-lg shadow-[inset_3px_3px_10px_0px_#00000010,7px_7px_8px_0px_#00000024] ">
    <a href="#" className="flex flex-col rounded-t-lg justify-center items-center p-5 ">
        <Image
              ...
              width={100}
              height={100}
              className="rounded-full ring-2 ring-pink-300 shadow-md bg-gray-200"
        />
        {/* <img class="rounded-t-lg" src="/docs/images/blog/image-1.jpg" alt="" />*/}
    </a>
    <div className="p-5 flex justify-center items-center ">
        <div className="text-center">
        <h5 className="mb-2 text-3xl font-bold tracking-tight text-twOfficial ">{nome}</h5>
